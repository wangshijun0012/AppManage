...
CREATE TABLE `user` (
  ...
  `username` varchar(12) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户名',
  `password` varchar(12) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户密码',
  `usertype` varchar(12) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `user` */

insert  into `user`(`id`,`username`,`password`,`usertype`) values (1,'wangshijun','1234','超级管理员'),(2,'test','1234','普通用户'),(3,'admin','1234','管理员');
